...
function Scipion_installer() {
    ...
    # Install scipion
    python -m scipioninstaller $SCIPATH  -j 4 
...
function Cryomethods_installer() {
    ...
    ln -s ~/Software/scipion/software/em/cryomethods-0.1/alignLib/SpharmonicKit27/libsphkit.so ~/Software/scipion/software/lib/libsphkit.so 
    ln -s ~/Software/scipion/software/em/cryomethods-0.1/alignLib/frm/swig/_swig_frm.so ~/Software/scipion/software/lib/_swig_frm.so
